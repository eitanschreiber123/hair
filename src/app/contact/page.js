  ...
  return (
      <main>
        ...
        <div style={{display:'flex', alignSelf:'center', marginBottom:'50px',width:'100%',justifyContent:'space-evenly',flexWrap:'wrap'}}>
            ...
            <svg width="50" height="50" viewBox="0 0 24 24" style={{width:'100px',height:'100px'}}>
            ...
            <svg width="50" height="50" viewBox="0 0 24 24" style={{width:'100px',height:'100px'}}><g>
            ...
            <Link style={{margin:'10px'}} href="https://www.youtube.com/@cutoffrecycle"><svg width="50" height="50" viewBox="0 0 24 24" style={{width:'100px',height:'100px'}}>
            ...
            <Link style={{margin:'10px'}} href="mailto:info@cutoffrecycle.co.tz"><svg width="50" height="50" viewBox="0 0 24 24" style={{width:'100px',height:'100px'}}>
            ...
            <div style={{width:'100%', padding:'0 10px'}}>
              <h2 style={{fontSize:'3em'}}>Message</h2>
